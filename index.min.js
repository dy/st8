'use strict';var n=require("enot/index.min"),p=require("mutypes"),q=require("each-csv");module.exports=r;var s=p.isObject,t=p.has,u=p.isFn,v=p.isPlain,w=p.isString,x=n.on,y=n.off,z="created",A="before",B="after",D="init",aa="changed",F="set",ba="get",G="_",H=new WeakMap,I=new WeakMap,J=new WeakMap,K=new WeakMap,L=new WeakMap,M=new WeakMap,O=new WeakMap;
