'use strict';module.exports=n;var r=require("enot/index.min"),s=require("mutypes"),t=require("each-csv"),u=s.isObject,v=s.has,w=s.isFn,x=s.isPlain,y=s.isString,z=r.on,A=r.off,aa="created",B="before",C="after",D="init",ba="changed",E="set",ca="get",G="_",H=new WeakMap,I=new WeakMap,J=new WeakMap,K=new WeakMap,L=new WeakMap,M=new WeakMap,N=new WeakMap;
